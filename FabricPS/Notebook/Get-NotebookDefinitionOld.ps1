function Get-NotebookDefinitionOld {
    <#
    .SYNOPSIS
    ...
    $uri = "https://api.fabric.microsoft.com/v1/workspaces/$WorkspaceId/notebooks/$NotebookId/getDefinition"
    $headers = @{
    ...
    # Define the request body if required by the API
    $body = @{
        # Add necessary parameters here if the API requires them
    }
